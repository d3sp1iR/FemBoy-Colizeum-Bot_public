...
def cmd_help(message):
    ...
    "/tops - таблица лидеров\n"
    "/rename <новое имя> - для смены ника\n"
    "/boss - вызов на дуэль босса (стоит 50 золотых)\n"
    "/status - выводит текущий статус бота\n")
...
def cmd_status(message):
    ...
    try:
        ...
        status_text = (
            ...
            f"📊 База данных: <code>{db.DB_PATH}</code>\n\n"
